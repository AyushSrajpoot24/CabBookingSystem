...
def RegisterPage():
    ...
    global securityanswer
    canvas.delete('all')
    backgroundIMG=PhotoImage(file="7-2-taxi-cab-png-clipart.png")
    ...
    Loginbutton=Button(canvas,text="Login",fg="white",bg="#008000",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def feedpage():
    ...
    global feedEntry
    canvas.delete('all')
    gifimg=PhotoImage(file="taxi_logos_PNG26.gif")
...
def adminloginpage():
    ...
    sbutton=Button(canvas,text="user section",width=10,fg="white",bg="#008000",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def changepasswordpage():
    ...
    backbutton=Button(canvas,text="Back",fg="white",bg="#FF0000",bd=0,font=("Arial",13,'bold'),command=gotocpage)
...
def loginpage():
    ...
    global canvas
    canvas.delete('all')
    backgroundIMG=PhotoImage(file="taxi_logos_PNG26.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="#000",outline="white")
    ...
    canvas.create_window(200,450,window=Loginbutton)
    Regbutton=Button(canvas,text="Register",fg="white",bg="#008000",bd=0,font=("Arial",13,'bold'),relief="sunken",command=RegisterPage)
